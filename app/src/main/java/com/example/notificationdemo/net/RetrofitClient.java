package com.example.notificationdemo.net;

import android.content.Context;
import android.text.TextUtils;
import android.util.Log;

import com.example.notificationdemo.net.entity.IpResult;
...
public class RetrofitClient {
    ...
    private static OkHttpClient.Builder httpClient =
            new OkHttpClient.Builder()
                    .addNetworkInterceptor(
                            new HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level
                                    .HEADERS))
    ...
    public static RetrofitClient getInstance(Context context, String url, Map<String, String>
            headers) {
        if (context != null) {
            mContext = context;
        }
    ...
    private RetrofitClient(Context context, String url, Map<String, String> headers) {
        ...
        okHttpClient = new OkHttpClient.Builder()
                ...
                .connectionPool(new ConnectionPool(6, 15, TimeUnit.SECONDS))
    ...
    public void post(String url, Map<String, String> parameters, Subscriber<ResponseBody>
            subscriber) {
    ...
    private class HandleFuc<T> implements Func1<BaseResponse<T>, T> {
        ...
        public T call(BaseResponse<T> response) {
            if (!response.isOk())
                throw new RuntimeException(response.getCode() + "" + response.getMsg() != null ?
                        response.getMsg() : "");
    ...
    class DownSubscriber<ResponseBody> extends Subscriber<ResponseBody> {
        ...
        public void onNext(ResponseBody responseBody) {
            DownLoadManager.getInstance(callBack).writeResponseBodyToDisk(mContext, (okhttp3
